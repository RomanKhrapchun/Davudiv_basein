...
const Services = () => {
    ...
    const handleAddFormSubmit = async () => {
        const { name, lesson_count, price, service_group_id } = addModalState.formData;

        // Валідація форми
        if (!name || !lesson_count || !price || !service_group_id?.value) {
            notification({
                type: 'warning',
                placement: 'top',
                title: 'Помилка',
                ...
                <div className="table-elements">
                    ...
                    <div className="table-main">
                        ...
                        <div className={`table-filter ${state.isOpen ? "table-filter--active" : ""}`}>
                            ...
                            <div className="table-filter__item">
                                <h4 className="input-description">Кількість занять</h4>
                                <Input
                                    icon={searchIcon}
                                    name="lesson_count"
                                    type="text"
                                    placeholder="Введіть одиницю виміру"
                                    value={state.selectData?.lesson_count || ''}
                                    onChange={onHandleChange}
                                />
                            </div>
                        </div>
                    ...
                    >
                        <div className="form-container">
                            ...
                            >
                                <Input
                                    name="lesson_count"
                                    value={addModalState.formData.lesson_count}
                                    onChange={onAddFormChange}
