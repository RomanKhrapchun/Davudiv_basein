        ...
        <BrowserRouter>
            <Routes>
                <Route exact path="/" element={<Home />}>
                    ...
                    {/* Sports complex */}
                    <Route exact path="sportscomplex/requisite" element={<Suspense fallback={<Loader />}><SportsRequisite /></Suspense>} />
                    ...
                    <Route path="sportscomplex/services/:serviceId" element={<Suspense fallback={<Loader/>}><SportsServiceView /></Suspense>} />
                    <Route path="sportscomplex/services/:serviceId/edit" element={<Suspense fallback={<Loader/>}><SportsServiceEdit /></Suspense>} />
